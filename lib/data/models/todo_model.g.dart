...
void _todoModelSerialize(
  ...
  writer.writeLong(offsets[8], object.repeatInterval);
  writer.writeString(offsets[9], object.repeatUnit);
...
TodoModel _todoModelDeserialize(
  ...
  object.repeatInterval = reader.readLongOrNull(offsets[8]);
  object.repeatUnit = reader.readStringOrNull(offsets[9]);
