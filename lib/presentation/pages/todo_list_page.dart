      ...
      ref
          ...
          .addTodo(
            ...
            repeatInterval: (_isRepeatEnabled && !finalIsAnytime)
                ? _repeatInterval
                : null,
            repeatUnit: (_isRepeatEnabled && !finalIsAnytime)
                ? _repeatUnit
                : null,
          );
      _controller.clear();
                          ...
                          AnimatedPadding(
                            ...
                            child: LayoutBuilder(
                              builder: (context, constraints) {
                                final double targetWidth = _isInputExpanded
                                    ? constraints.maxWidth
                                    : 32.0;
                                final double targetHeight = _isInputExpanded
                                    ? 44.0
                                    : 32.0;
                                                                  ...
                                                                  if (_isAnytimeSelected ||
                                                                    ...
                                                                    Text(
                                                                      (() {
                                                                        ...
                                                                        if (_isRepeatEnabled) {
                                                                          final repeatStr =
                                                                              '${Translations.tr('every', locale)}$_repeatInterval ${getRepeatUnitLabel(_repeatUnit)}';
...
class _SyncIconWidgetState extends ConsumerState<_SyncIconWidget>
