...
**Zenist** is a minimalist, offline-first task management application designed for deep focus on Windows. 
...
* **Bring Your Own Cloud**: Your data is synchronized entirely through your personal cloud drive (Dropbox), ensuring absolute privacy and ownership.

## ✨ Key Features
* **Minimalist UI**: Designed with a sleek black, white, and grey palette to keep you focused on what matters.
...
* **Clean Uninstallation**: Intelligent uninstaller that gracefully closes the app and cleans up registry entries.

## 🛠️ Tech Stack
Zenist is proudly built with modern, cross-platform technologies:
...
### Download & Install
You can download the latest Windows installer (`.exe`) from the [Releases](https://github.com/ChiesiMario/Zenist/releases/latest) page.

### Build from Source
If you wish to build Zenist from source or contribute to the project:

1. Make sure you have [Flutter](https://docs.flutter.dev/get-started/install/windows) installed on your system.
...
5. Build the Windows executable:
   ...
   ```
*(To build the installer, you will need to compile `windows/zenist_installer.iss` using Inno Setup).*
